...
//int shiftSize = (trueArraySize*2) - 1;
...
/*double siren[35] = {31.68, 77.24, 120.06, 162.64, 203.85, 244.21, 284.29, 213.54, 29.40, 93.65,
...
/*double siren[36] = {20.46, 29.49, 21.30, 337.50, 188.66, 337.12, 326.33, 28.20, 335.59, 27.94,
...
void setup()
{
    ...
    //Fill the fron tof the siren with zero
