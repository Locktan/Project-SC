...
void directionality()
{
  while (z < 5)
  {
    ...
    while (millis() - startMillis < sampleWindow)
    {
      ...
      mic7Sample = analogRead(A8);
      mic8Sample = analogRead(A9);
