...
void directionality()
{
  ...
  while (z < 50)
  {
    ...
    {  
      /*double micsAnalog[8] = {analogRead(mic1)*1.1029, analogRead(mic2)*.8929, analogRead(mic3)*1.1029, analogRead(mic4)*.9375, 
                            analogRead(mic5)*.9063, analogRead(mic6)*.9797, analogRead(mic7)*.9539, analogRead(mic8)*1.2083};*/
      double micsAnalog[8] = {analogRead(mic1)*0.9994, analogRead(mic2)*0.9929, analogRead(mic3)*0.9969, analogRead(mic4)*0.9987, 
                            analogRead(mic5)*1.0021, analogRead(mic6)*1.0042, analogRead(mic7)*1.0056, analogRead(mic8)*1.0058}; 
