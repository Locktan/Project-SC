...
//Use in siren detection
//Get the frequency spectrum and store them in the vReal[] array 
void getFFT()
{ 
  //SAMPLING
...
//Display the siren name and print to the screen while flashing blue and red
...
//Return the state of which tell there is a mic fail present in the device or not
